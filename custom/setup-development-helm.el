(provide 'setup-development-helm)
...
(use-package helm
  ...
  (progn
	...
	;(add-to-list 'grep-find-ignored-directories "xxx")
...
;;; Save current position to mark ring
    ...
    (use-package helm-projectile
	  ...
	  ;; exclude file and directories
	  ;(add-to-list 'projectile-globally-ignored-directories "xxx")
